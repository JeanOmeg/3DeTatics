<template>
  <q-page class="q-pa-md">
    ...
    >
      ...
      <q-card-section>
        <p
          v-for="(item, index) in lista_desvantagens"
          :key="index"
          class="text-body1"
        >
...
const lista_desvantagens = ref(VantagensEDesvantagensLib.listarVantagensEDesvantagens().filter(item => item.tipo == TipoVantagemEnum.desvantagem))
</script>
